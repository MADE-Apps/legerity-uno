...
These guidelines are designed to help you as a contributor to bring your code and skills to the Legerity for Uno project to make it better.

## What can I contribute to?

Our [issue tracker](https://github.com/MADE-Apps/legerity-uno/issues) contains a collection of features and issues waiting to be worked on! If you see any item marked with **Help Wanted**, we'd like to see you put your skills to use and contribute whatever you can to help develop the feature.
