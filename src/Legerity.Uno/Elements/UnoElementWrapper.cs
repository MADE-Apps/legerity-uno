...
/// <summary>
/// Defines a base wrapper for Uno Platform elements to expose element logic.
/// </summary>
public class UnoElementWrapper : IElementWrapper<RemoteWebElement>
{
    private readonly WeakReference elementReference;

    /// <summary>
    /// Initializes a new instance of the <see cref="UnoElementWrapper"/> class.
    /// </summary>
    /// <param name="element">
    /// The <see cref="IWebElement"/> reference.
    /// </param>
    public UnoElementWrapper(IWebElement element)
    ...
    /// </param>
    public UnoElementWrapper(RemoteWebElement element)
    {
    ...
    /// <summary>
    /// Allows conversion of a <see cref="RemoteWebElement"/> to the <see cref="UnoElementWrapper"/> without direct casting.
    /// </summary>
    /// <param name="element">
    /// The <see cref="RemoteWebElement"/>.
    /// </param>
    /// <returns>
    /// The <see cref="UnoElementWrapper"/>.
    /// </returns>
    public static implicit operator UnoElementWrapper(RemoteWebElement element)
    {
        return new UnoElementWrapper(element);
    }
    ...
    /// </summary>
    /// <param name="locator">The locator to find child elements by.</param>
