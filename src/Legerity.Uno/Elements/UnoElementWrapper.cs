...
namespace Legerity.Uno.Elements
{
    ...
    public abstract class UnoElementWrapper : IElementWrapper<RemoteWebElement>
    {
        ...
        /// </summary>
        public RemoteWebDriver Driver => AppManager.App;
        ...
        /// <param name="locator">The locator for the element to find.</param>
        /// <exception cref="ElementNotShownException">Thrown if the element is not shown.</exception>
        ...
        /// <summary>Determines whether the specified elements are shown.</summary>
        /// <param name="locator">The locator for the element to find.</param>
        ...
        /// <summary>Determines whether the given element is not shown.</summary>
        /// <param name="locator">The locator for the element to locate.</param>
